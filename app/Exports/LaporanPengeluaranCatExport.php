...
class LaporanPengeluaranCatExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
{
  protected $params;
  protected $cabang;
  protected $periode;
  ...
  {
    $query = DB::table('v_rep_pengeluaran_cat')
    ...
    foreach ($this->data as $row) {
      // Jika nama cat berubah dan bukan data pertama
      // if ($this->currentCat !== null && $this->currentCat !== $row->nama_cat) {
