...
class LaporanBankUrutVoucherExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
{
  protected $params;
  protected $cabang;
  protected $periode;
  ...
  public function map($row): array
  {
    ...
    $kredit = ($row->kredit == 0) ? '0' : ($row->kredit * -1);
