...
// class LaporanAnalisaPemakaianCatExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
class LaporanAnalisaPemakaianCatExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents, WithCustomValueBinder
{
  protected $params;
  protected $cabang;
  protected $periode;
  ...
  // {
  //   $query = DB::table('v_rep_rekap_analisa_cat')
  ...
  //   // Hitung jumlah panel
  //   $this->jumlahPanel = DB::table('v_rep_rekap_analisa_cat')
  //     ->where('kode_cabang', $this->cabang['kode'])
