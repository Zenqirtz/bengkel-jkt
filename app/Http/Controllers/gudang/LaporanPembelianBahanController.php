...
use App\Exports\LaporanPembelianBahanExport;

use App\Helpers\Helpers as Helper;

class LaporanPembelianBahanController extends Controller
{
  /**
   * Redirect to view.
   */
  public function LaporanPembelianBahan(): View
  {
    ...
    $path = request()->path();
    $title = Helper::getTitleMenu($path) ?? 'Laporan Pembelian Bahan';
    ...
    return view('content.gudang.laporan.laporan-pembelian-bahan', [
      'title' => $title,
      'isList' => $isList,
      'isAdd' => $isAdd,
      'isEdit' => $isEdit,
  ...
  public function index(Request $request): JsonResponse
  {
    ...
    $query = DB::table('v_rep_pembelian_bahan as k')
  ...
  public function store(Request $request)
  {
    ...
    return redirect('gudang/laporan-pembelian-bahan')->with('datafilter', $dataArray);
  }
  ...
  public function exportExcel(Request $request)
  {
    ...
    $fileName = 'Laporan_Pembelian_Bahan_' . date('Ymd_His') . '.xlsx';

    return Excel::download(
      new LaporanPembelianBahanExport($filters, $cabangData, $periodeStr),
      $fileName
    );
  }
  ...
  public function printData(Request $request)
  {
    ...
    $pageConfigs = ['myLayout' => 'blank'];
    return view('content.gudang.laporan.laporan-pembelian-bahan-print', [
      'title' => $title,
