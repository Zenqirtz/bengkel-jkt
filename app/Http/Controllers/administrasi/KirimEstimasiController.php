...
class KirimEstimasiController extends Controller
{
  ...
  public function KirimEstimasi(): View
  {
    ...
    return view('content.administrasi.kirim-estimasi', [
      'title' => $title,
      'isList' => $isList,
      'isAdd' => $isAdd,
      'isEdit' => $isEdit,
  ...
  public function index(Request $request): JsonResponse
  {
    ...
    ->leftJoin('t_estimasi_hdr as f', function ($join) {
  ...
  public function store(Request $request)
  {
    ...
    if ($dataID) {
      ...
      $data = [
        'tgl_pengiriman' => blank($request->tgl_pengiriman) ? null : Carbon::createFromFormat('d/m/Y', trim($request->tgl_pengiriman), 'Asia/Jakarta')->format('Y-m-d'),
        'pengirim' => $request->pengirim,
        'penerima' => Auth::user()->name, //$request->penerima,
      ...
      if(blank($request->kode_pengiriman)) {
        ...
        $data['kode_pengiriman'] = $penomoran;
      }
      ...
      ## Log Activity
      $desc = $result ? 'Berhasil Proses Kirim Estimasi' : 'Gagal Proses Kirim Estimasi';
  ...
  public function edit($id): JsonResponse
  {
    ...
    $data->tgl_pengiriman = blank($data->tgl_pengiriman) ? '' : date("d/m/Y", strtotime($data->tgl_pengiriman));
  ...
  public function destroy($id): JsonResponse
  {
    ...
    $desc = $ok ? 'Berhasil Hapus Kirim Estimasi' : 'Gagal Hapus Kirim Estimasi';
