...
//   const dt_analisa_cat_table = document.querySelector('.datatables-analisa-cat');
//   if (dt_analisa_cat_table) {
//     isAdd = dt_analisa_cat_table.dataset.add;

//     dt_analisa_cat = new DataTable(dt_analisa_cat_table, {
//       searching: false,
//       ordering: false,
//       paging: false,
//       processing: true,
...
//       scrollX: true,
//       ajax: {
//         url: baseUrl + 'laporan-analisa-cat-list',
//         data: function (d) {
...
//           // Update display periode dan jumlah panel
//           if (json.periode) {
//             $('#display-periode').text(json.periode);
//           }
//           if (json.jumlah_panel) {
...
//         window.location.href = `${baseUrl}laporan-analisa-cat/export?` + queryString;
//       } else {
//         Swal.fire({
//           icon: 'error',
//           title: 'Error!',
...
//         let queryString = $.param(params);
//         const printUrl = `${baseUrl}laporan-analisa-cat/print?` + queryString;
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  function initDataTable(jenisReport) {
    if (dt_analisa_cat) {
      dt_analisa_cat.destroy();
      $(dt_analisa_cat_table).find('tbody').remove();
    }

    const theadHtml = jenisReport === 'Rekap' ? getTheadRekap() : getTheadRinci();
    $(dt_analisa_cat_table).find('thead').html(theadHtml);
