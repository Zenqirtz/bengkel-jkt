 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
  let isAdd, isEdit, isDelete;
   ...
   const dt_os_tahun_table = document.querySelector('.datatables-outstanding-tahun');
   if (dt_os_tahun_table) {
     ...
     const dt_os_tahun = new DataTable(dt_os_tahun_table, {
       ...
       scrollX: true,
       ajax: {
        url: baseUrl + 'laporan-outstanding-list',
        data: function (d) {
    ...
    const dt_os_periode_table = document.querySelector('.datatables-outstanding-periode');
   ...
   if (exportBtn) {
      exportBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          window.location.href = `${baseUrl}laporan-outstanding/export?` + queryString;
        } else {
          // Hide offcanvas
   ...
   if (printBtn) {
    printBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          // Redirect window untuk download file
          // Pastikan route URL sesuai dengan konfigurasi route Anda
          // window.location.href = `${baseUrl}laporan-outstanding/print?` + queryString;
          const printUrl = `${baseUrl}laporan-outstanding/print?` + queryString;
