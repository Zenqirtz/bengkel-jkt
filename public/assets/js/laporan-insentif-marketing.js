...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_insentif_table = document.querySelector('.datatables-insentif-marketing');
  if (dt_insentif_table) {
    ...
    const dt_insentif = new DataTable(dt_insentif_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'laporan-insentif-marketing-list',
        data: function (d) {
      ...
      columns: [
        ...
        { data: 'nama_pelanggan' },
        { data: 'kode_estimasi' },
        { data: 'total_estimasi', className: 'text-end' }
      ]
    });
  }
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        window.location.href = `${baseUrl}laporan-insentif-marketing/export?` + queryString;
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Error!',
  ...
  if (printBtn) {
    printBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        let queryString = $.param(params);
        const printUrl = `${baseUrl}laporan-insentif-marketing/print?` + queryString;
