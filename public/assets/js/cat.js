 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-cat'),
  ...
  if (dt_basic_table) {
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-cat .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-cat .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}cat-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-jenis').value = data.jenis;
            document.getElementById('add-rasio').value = data.rasio;

            setSelectValue('#add-kode-bahan', data.kode_bahan, '');
          });
        }
      });
    }
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}cat-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-nama-cat')?.focus();
        } else {
          // Hide offcanvas
    ...
    const fv = FormValidation.formValidation(addNewDataForm, {
      fields: {
        kode_bahan: {
          validators: {
            notEmpty: {
              message: 'Silahkan Input Nama Cat'
            }
          }
        },
        rasio: {
 ...
 function clearFormData() {
    ...
    clearSelect('#add-kode-bahan');

    $('#add-kode-bahan').addClass('is-invalid');
    $('#add-rasio').addClass('is-invalid');
