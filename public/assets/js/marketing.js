 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-marketing'),
  ...
  if (dt_basic_table) {
    ...
    const dt_basic = new DataTable(dt_basic_table, {
      ...
      ajax: {
        ...
        data: function (d) {
          ...
          d.nama_marketing = $('#filter-nama-marketing').val();
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-marketing .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-marketing .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}marketing-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-nama-marketing').value = data.nama;
            document.getElementById('add-telepon').value = data.no_hp;
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}marketing-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-nama-marketing')?.focus();
        } else {
          // Hide offcanvas
 ...
 function clearFormData() {
    ...
    // clearSelect('#add-jenis-marketing');
    clearSelect('#add-status-aktif');

    $('#add-nama-marketing').addClass('is-invalid');
