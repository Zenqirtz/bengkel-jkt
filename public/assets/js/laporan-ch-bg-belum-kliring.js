...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_bank_urut_table = document.querySelector('.datatables-ch-bg-belum-kliring');
  if (dt_bank_urut_table) {
    ...
    const dt_bank_urut = new DataTable(dt_bank_urut_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'laporan-ch-bg-belum-kliring-list',
        data: function (d) {
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function () {
      if(isAdd) {
        ...
        window.location.href = `${baseUrl}laporan-ch-bg-belum-kliring/export?` + queryString;
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Error!',
  ...
  if (printBtn) {
    printBtn.addEventListener('click', function () {
      if(isAdd) {
        ...
        let queryString = $.param(params);
        const printUrl = `${baseUrl}laporan-ch-bg-belum-kliring/print?` + queryString;
  ...
  if (filterForm) {
    const fv = FormValidation.formValidation(filterForm, {
      ...
      const url = `${baseUrl}laporan-ch-bg-belum-kliring-list?` + queryString;
