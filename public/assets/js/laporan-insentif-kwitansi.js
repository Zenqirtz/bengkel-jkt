...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_insentif_table = document.querySelector('.datatables-insentif-kwitansi');
  if (dt_insentif_table) {
    ...
    const dt_insentif = new DataTable(dt_insentif_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'laporan-insentif-kwitansi-list',
        data: function (d) {
      ...
      columns: [
        ...
        { data: 'tgl_kirim_estimasi', className: 'text-center' },
        { data: 'tanggal_kwitansi', className: 'text-center' },
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        window.location.href = `${baseUrl}laporan-insentif-kwitansi/export?` + queryString;
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Error!',
  ...
  if (printBtn) {
    printBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        let queryString = $.param(params);
        const printUrl = `${baseUrl}laporan-insentif-kwitansi/print?` + queryString;
