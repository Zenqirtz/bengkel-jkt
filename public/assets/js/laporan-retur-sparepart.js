...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_retur_sparepart_table = document.querySelector('.datatables-retur-sparepart');
  if (dt_retur_sparepart_table) {
    isAdd = dt_retur_sparepart_table.dataset.add;

    dt_retur_sparepart = new DataTable(dt_retur_sparepart_table, {
      searching: false,
      ordering: false,
      paging: false,
      processing: true,
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'laporan-retur-sparepart-list',
        data: function (d) {
      ...
      columns: [
        ...
        { data: 'tgl_retur', className: 'text-center' },
        { data: 'no_retur' },
        { data: 'tgl_input_gudang', className: 'text-center' },
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        window.location.href = `${baseUrl}laporan-retur-sparepart/export?` + queryString;
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Error!',
  ...
  if (printBtn) {
    printBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        let queryString = $.param(params);
        const printUrl = `${baseUrl}laporan-retur-sparepart/print?` + queryString;
