 ...
 document.addEventListener('DOMContentLoaded', function (e) {
  let isAdd, isEdit, isDelete;
   ...
   $.ajaxSetup({
    ...
    const dt_pos_perbaikan_table = document.querySelector('.datatables-posisi-perbaikan');
    if (dt_pos_perbaikan_table) {
      isAdd = dt_pos_perbaikan_table.dataset.add;
      const dt_pos_perbaikan = new DataTable(dt_pos_perbaikan_table, {
        ...
        scrollX: true,
        ajax: {
          url: baseUrl + 'laporan-posisi-perbaikan-list',
          data: function (d) {
   ...
   if (exportBtn) {
      exportBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          window.location.href = `${baseUrl}laporan-posisi-perbaikan/export?` + queryString;
        } else {
          // Hide offcanvas
   ...
   if (printBtn) {
    printBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          // Redirect window untuk download file
          // Pastikan route URL sesuai dengan konfigurasi route Anda
          // window.location.href = `${baseUrl}laporan-posisi-perbaikan/print?` + queryString;
          const printUrl = `${baseUrl}laporan-posisi-perbaikan/print?` + queryString;
