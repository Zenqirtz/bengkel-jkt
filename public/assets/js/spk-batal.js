 ...
 */
       ...
       if (e.target.closest('.delete-record')) {
          if (isDelete) {
            ...
            Swal.fire({
              ...
              if (result.value) {
                // delete the data
                fetch(`${baseUrl}spk-batal-list/${user_id}`, {
                  method: 'DELETE',
                  headers: {
     ...
     document.addEventListener('click', function (e) {
       if (e.target.closest('.edit-record')) {
          if(isEdit) {
            ...
            // get data
            fetch(`${baseUrl}spk-batal-list/${user_id}/edit`)
          ...
          if (!selectedCheckbox) {
            ...
            .then(result => {
              ...
              if(status) {
                ...
                document.getElementById('add-tgl-batal').value = data.tgl_batal;
                document.getElementById('add-batal-by').value = data.batal_by;
                document.getElementById('add-alasan-batal').value = data.memo_batal;
      ...
      const FormValidation2 = FormValidation.formValidation(wizardPropertyListingFormStep2, {
        fields: {
          ...
          tgl_batal: {
            validators: {
              notEmpty: {
                message: 'Silahkan Input Tanggal Batal'
              }
            }
          },
          batal_by: {
            validators: {
              notEmpty: {
                message: 'Silahkan Input Dibatalkan Oleh'
              }
            }
          },
          memo_batal: {
            validators: {
              notEmpty: {
                message: 'Silahkan Input Alasan Pembatalan'
              }
            }
          }
        },
 ...
 function clearFormData() {
  ...
  $('#add-tgl-batal').addClass('is-invalid');
  $('#add-batal-by').addClass('is-invalid');
  $('#add-alasan-batal').addClass('is-invalid');
