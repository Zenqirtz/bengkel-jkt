...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_pengeluaran_bahan_table = document.querySelector('.datatables-pengeluaran-bahan');
  if (dt_pengeluaran_bahan_table) {
    isAdd = dt_pengeluaran_bahan_table.dataset.add;

    dt_pengeluaran_bahan = new DataTable(dt_pengeluaran_bahan_table, {
      searching: false,
      ordering: false,
      paging: false,
      processing: true,
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'laporan-pengeluaran-bahan-list',
        data: function (d) {
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        window.location.href = `${baseUrl}laporan-pengeluaran-bahan/export?` + queryString;
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Error!',
  ...
  if (printBtn) {
    printBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        let queryString = $.param(params);
        const printUrl = `${baseUrl}laporan-pengeluaran-bahan/print?` + queryString;
