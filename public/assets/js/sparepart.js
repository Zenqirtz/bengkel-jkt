 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-sparepart'),
  ...
  if (dt_basic_table) {
    ...
    const dt_basic = new DataTable(dt_basic_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'sparepart-list',
        data: function (d) {
          // Ambil data dari input form modal dan masukkan ke parameter request
          d.nama_sparepart = $('#filter-nama-sparepart').val();
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-sparepart .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-sparepart .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}sparepart-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-nama-sparepart').value = data.nama_sparepart;
            // document.getElementById('add-harga').value = data.price;
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}sparepart-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-nama-sparepart')?.focus();
        } else {
          // Hide offcanvas
 ...
 function clearFormData() {
    ...
    $('#add-nama-sparepart').addClass('is-invalid');
    $('#add-satuan-beli').addClass('is-invalid');
