 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-umum'),
  ...
  if (dt_basic_table) {
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-umum .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-umum .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}umum-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-nama-barang').value = data.nama_barang;
            // document.getElementById('add-harga').value = data.price;

            setSelectValue('#add-jenis', data.kode_jenis, '');
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}umum-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-nama-umum')?.focus();
        } else {
          // Hide offcanvas
