  ...
  if (dt_basic_table) {
    ...
    isDelete = dt_basic_table.dataset.delete;
     ...
     const dt_basic = new DataTable(dt_basic_table, {
       ...
       serverSide: true,
       ajax: {
         url: baseUrl + 'kirim-salvage-list',
         data: function (d) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}kirim-salvage-list/${user_id}/edit`)
          .then(response => {
            if (!response.ok) {
          ...
          .then(result => {
            ...
            if(status) {
              ...
              document.getElementById('add-nomor-pengiriman').value = data.no_pengiriman;
              document.getElementById('add-tanggal-kirim').value = data.tgl_kirim;
              document.getElementById('add-pengirim').value = data.pengirim;
              document.getElementById('add-penerima').value = data.penerima;
      ...
      const fv = FormValidation.formValidation(addNewDataForm, {
        fields: {
          tgl_kirim: {
            validators: {
              notEmpty: {
                message: 'Silahkan Input Tanggal Kirim'
              }
            }
          },
          pengirim: {
            validators: {
              notEmpty: {
                message: 'Silahkan Input Nama Pengirim'
              }
            }
          },
          penerima: {
        ...
        fetch(`${baseUrl}kirim-salvage-list`, {
          method: 'POST',
          headers: {
