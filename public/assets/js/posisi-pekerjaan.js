 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-posisi-pekerjaan'),
  ...
  if (dt_basic_table) {
    ...
    const dt_basic = new DataTable(dt_basic_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'posisi-pekerjaan-list',
        data: function (d) {
          // Ambil data dari input form modal dan masukkan ke parameter request
          d.posisi_pekerjaan = $('#filter-posisi-pekerjaan').val();
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-posisi-pekerjaan .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-posisi-pekerjaan .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}posisi-pekerjaan-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-posisi-pekerjaan').value = data.posisi_pekerjaan;
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}posisi-pekerjaan-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-posisi-pekerjaan')?.focus();
        } else {
          // Hide offcanvas
  ...
  if (addNewDataForm) {
    const fv = FormValidation.formValidation(addNewDataForm, {
      ...
      fetch(`${baseUrl}posisi-pekerjaan-list`, {
        method: 'POST',
        headers: {
          'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
 ...
 function clearFormData() {
    ...
    $('#add-posisi-pekerjaan').addClass('is-invalid');
