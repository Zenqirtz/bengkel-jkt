/**
 * Laporan Estimasi Belum Dikirim
 */
...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_estimasi_table = document.querySelector('.datatables-estimasi-belum-dikirim');
  if (dt_estimasi_table) {
    ...
    const dt_estimasi = new DataTable(dt_estimasi_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'laporan-estimasi-dikirim-list',
        data: function (d) {
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        window.location.href = `${baseUrl}laporan-estimasi-dikirim/export?` + queryString;
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Error!',
  ...
  if (printBtn) {
    printBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        let queryString = $.param(params);
        const printUrl = `${baseUrl}laporan-estimasi-dikirim/print?` + queryString;
