 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
  ...
  if (dt_basic_table) {
    ...
    isDelete = dt_basic_table.dataset.delete;
     ...
     const dt_basic = new DataTable(dt_basic_table, {
       ...
       serverSide: true,
       ajax: {
         url: baseUrl + 'kirim-estimasi-list',
         data: function (d) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}kirim-estimasi-list/${user_id}/edit`)
          .then(response => {
            if (!response.ok) {
          ...
          .then(result => {
            ...
            if(status) {
              ...
              document.getElementById('kode_pengiriman').value = data.kode_pengiriman;
              ...
              document.getElementById('add-nomor-pengiriman').value = data.kode_pengiriman;
              document.getElementById('add-tanggal-kirim').value = data.tgl_pengiriman;
              document.getElementById('add-nama-pengirim').value = data.pengirim;
              // document.getElementById('add-nama-penerima').value = data.penerima;
    ...
    if (addNewDataForm) {
      const fv = FormValidation.formValidation(addNewDataForm, {
        ...
        fetch(`${baseUrl}kirim-estimasi-list`, {
          method: 'POST',
          headers: {
  ...
  function clearFormData() {
    ...
    $('#add-tanggal-kirim').addClass('is-invalid');
    $('#add-nama-pengirim').addClass('is-invalid');
