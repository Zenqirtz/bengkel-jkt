...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_gudang_cat_table = document.querySelector('.datatables-gudang-cat');
  if (dt_gudang_cat_table) {
    isAdd = dt_gudang_cat_table.dataset.add;

    // dt_gudang_cat = new DataTable(dt_gudang_cat_table, {
    //   searching: false,
    //   ordering: false,
    //   paging: false,
    //   processing: true,
    ...
    //   scrollX: true,
    //   ajax: {
    //     url: baseUrl + 'laporan-gudang-cat-list',
    //     data: function (d) {
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        window.location.href = `${baseUrl}laporan-gudang-cat/export?` + queryString;
      } else {
        Swal.fire({
          icon: 'error',
          title: 'Error!',
  ...
  if (printBtn) {
    printBtn.addEventListener('click', function () {
      if (isAdd) {
        ...
        let queryString = $.param(params);
        const printUrl = `${baseUrl}laporan-gudang-cat/print?` + queryString;
