 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-jenis-pekerjaan'),
  ...
  if (dt_basic_table) {
    ...
    const dt_basic = new DataTable(dt_basic_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'jenis-pekerjaan-list',
        data: function (d) {
          // Ambil data dari input form modal dan masukkan ke parameter request
          d.jenis_pekerjaan = $('#filter-jenis-pekerjaan').val();
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-jenis-pekerjaan .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-jenis-pekerjaan .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}jenis-pekerjaan-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-jenis-pekerjaan').value = data.jenis_pekerjaan;
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}jenis-pekerjaan-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-jenis-pekerjaan')?.focus();
        } else {
          // Hide offcanvas
  ...
  if (addNewDataForm) {
    const fv = FormValidation.formValidation(addNewDataForm, {
      ...
      fetch(`${baseUrl}jenis-pekerjaan-list`, {
        method: 'POST',
        headers: {
          'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
 ...
 function clearFormData() {
    ...
    // clearSelect('#add-jenis-jenis-pekerjaan');
    clearSelect('#add-status-aktif');

    $('#add-jenis-pekerjaan').addClass('is-invalid');
