 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-panel-pekerjaan'),
  ...
  if (dt_basic_table) {
    ...
    const dt_basic = new DataTable(dt_basic_table, {
      ...
      scrollX: true,
      ajax: {
        url: baseUrl + 'panel-pekerjaan-list',
        data: function (d) {
          // Ambil data dari input form modal dan masukkan ke parameter request
          d.panel_pekerjaan = $('#filter-panel-pekerjaan').val();
          d.point = $('#filter-point').val();
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-panel-pekerjaan .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-panel-pekerjaan .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}panel-pekerjaan-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-panel-pekerjaan').value = data.panel_pekerjaan;
            document.getElementById('add-point').value = data.point;
            document.getElementById('add-nomor-panel').value = data.no_panel;
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}panel-pekerjaan-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-panel-pekerjaan')?.focus();
        } else {
          // Hide offcanvas
  ...
  if (addNewDataForm) {
    const fv = FormValidation.formValidation(addNewDataForm, {
      ...
      fetch(`${baseUrl}panel-pekerjaan-list`, {
        method: 'POST',
        headers: {
          'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
 ...
 function clearFormData() {
    ...
    // clearSelect('#add-panel-panel-pekerjaan');
    clearSelect('#add-status-aktif');

    $('#add-panel-pekerjaan').addClass('is-invalid');
