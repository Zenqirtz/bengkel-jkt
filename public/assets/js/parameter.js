 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-parameter'),
  ...
  if (dt_basic_table) {
    ...
    const dt_basic = new DataTable(dt_basic_table, {
      ...
      ajax: {
        ...
        data: function (d) {
          ...
          d.keterangan = $('#filter-keterangan').val();
          d.nama_tabel = $('#filter-nama-tabel').val();
        },
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-parameter .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-parameter .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}parameter-list/${user_id}/edit`)
          ...
          .then(data => {
            ...
            document.getElementById('add-kode').value = data.kode;
            document.getElementById('add-keterangan').value = data.keterangan;
            document.getElementById('add-nomor-urut').value = data.no_urut;

            setSelectValue('#add-nama-tabel',   data.nama_tabel,  '');
          });
        }
      });
    }
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}parameter-list/${user_id}`, {
                method: 'DELETE',
                headers: {
    ...
    if (addNewBtn) {
      addNewBtn.addEventListener('click', function () {
        if(isAdd) {
          ...
          document.getElementById('add-nama-parameter')?.focus();
        } else {
          // Hide offcanvas
  ...
  $('#TableNameOther').hide();
  $('#add-nama-tabel').on('change', function() {
    var value = $('#add-nama-tabel').val();
    if (value == 'other') {
      $('#TableNameOther').show();
    } else {
      $('#TableNameOther').hide();
 ...
 function clearSelect(selector, { keepOptions = true } = {}) {
  ...
  function clearFormData() {
    ...
    clearSelect('#add-nama-tabel');

    $('#add-kode').addClass('is-invalid');
    $('#add-keterangan').addClass('is-invalid');
  }
