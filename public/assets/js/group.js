 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-group'),
   ...
   if (dt_basic_table) {
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-group .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-group .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}group-list/${user_id}/edit`)
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}group-list/${user_id}`, {
                method: 'DELETE',
                headers: {
     ...
     const fv = FormValidation.formValidation(addNewDataForm, {
       fields: {
        nama: {
          validators: {
            notEmpty: {
              message: 'Silahkan Input Nama Group'
            }
          }
        },
        keterangan: {
