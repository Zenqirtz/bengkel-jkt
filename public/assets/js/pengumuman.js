 ...
 */
 ...
 document.addEventListener('DOMContentLoaded', function (e) {
   ...
   const dt_basic_table = document.querySelector('.datatables-pengumuman'),
  ...
  if (dt_basic_table) {
    ...
    const dt_basic = new DataTable(dt_basic_table, {
      ...
      columns: [
        ...
        { data: 'id', width: '20px' },
        { data: 'id', width: '30px' },
        { data: 'startdate', className: 'text-nowrap' },
        { data: 'enddate', className: 'text-nowrap' },
        { data: 'notes' },
      ],
      columnDefs: [
        {
    ...
    document.addEventListener('click', function (e) {
      const chk = e.target.closest('.datatables-pengumuman .dt-checkboxes');
      if (chk) {
        if (chk.checked) {
    ...
    if (btnEditSelected) {
      btnEditSelected.addEventListener('click', function () {
        ...
        const selectedCheckbox = document.querySelector('.datatables-pengumuman .dt-checkboxes:checked');
        ...
        if (!selectedCheckbox) {
          ...
          // get data
          fetch(`${baseUrl}pengumuman-list/${user_id}/edit`)
      ...
      btnDeletedSelected.addEventListener('click', function () {
        ...
        if (!selectedCheckbox) {
          ...
          Swal.fire({
            ...
            if (result.value) {
              // delete the data
              fetch(`${baseUrl}pengumuman-list/${user_id}`, {
                method: 'DELETE',
                headers: {
