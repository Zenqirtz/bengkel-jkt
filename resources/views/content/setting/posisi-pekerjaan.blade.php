...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/posisi-pekerjaan.js') }}"></script>
@endsection
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-posisi-pekerjaan table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-posisi-pekerjaan">Posisi Pekerjaan</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-posisi-pekerjaan" class="form-control form-control-sm text-uppercase" maxlength="100" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('posisi-pekerjaan-list') }}">
            @csrf
            <input type="hidden" name="id" id="user_id">
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-posisi-pekerjaan">Posisi Pekerjaan</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-posisi-pekerjaan" class="form-control form-control-sm text-uppercase" name="posisi_pekerjaan" maxlength="100" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-no-urut">No Urut</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-no-urut" class="form-control form-control-sm text-number" name="seq_no" maxlength="3" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
