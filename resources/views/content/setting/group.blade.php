...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-group table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-nama">Nama Group</label>
                  <div class="col-sm-9">
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addNewDataForm" method="post" action="{{ url('group-list') }}">
          @csrf
          ...
          <div class="row g-2">
            <div class="col-md-6">
              <div class="row mb-1 align-items-center">
                <label class="col-sm-3 col-form-label" for="add-nama">Nama Group</label>
                <div class="col-sm-9 form-control-validation">
                  <input type="text" id="add-nama" class="form-control form-control-sm text-uppercase" name="nama" maxlength="64" />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
            ...
            <div class="col-md-6">
              <div class="row mb-1 align-items-center">
                ...
                <div class="col-sm-9 form-control-validation">
                  <input type="text" id="add-keterangan" class="form-control form-control-sm text-uppercase" name="keterangan" maxlength="128" />
                </div>
              </div>
            </div>
          </div>
