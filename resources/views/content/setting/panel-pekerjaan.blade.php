...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/panel-pekerjaan.js') }}"></script>
@endsection
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-panel-pekerjaan table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-panel-pekerjaan">Panel Pekerjaan</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-panel-pekerjaan" class="form-control form-control-sm text-uppercase" maxlength="50" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-point">Point</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-point" class="form-control form-control-sm text-decimal" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('panel-pekerjaan-list') }}">
            @csrf
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-panel-pekerjaan">Panel Pekerjaan</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-panel-pekerjaan" class="form-control form-control-sm text-uppercase" name="panel_pekerjaan" maxlength="50" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-point">Point</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-point" class="form-control form-control-sm text-decimal" name="point" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-nomor-panel">No Panel</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-nomor-panel" class="form-control form-control-sm text-uppercase" name="no_panel" maxlength="10" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
