...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/cabang-privilege.js') }}"></script>

  <script>
    // ganti 'user-privilege' sesuai route GET yang menampilkan halaman index
    const USER_PRIV_INDEX_URL = @json(url('cabang-privilege-list'));
  </script>
@endsection
...
<div class="col-12">
  <div class="card">
    ...
    <div class="card-body">
      <form name="myForm" id="myForm" method="post" action="{{ url('cabang-privilege-list') }}" autocomplete="off">
      @csrf
      <div class="row mb-4">
      ...
      <div class="row">
        <div class="col-lg-5 p-6 pt-0">
          <small class="fw-medium">Daftar Cabang Yang Dimiliki User</small>
          <div class="demo-inline-spacing mt-4">
            <div class="list-group">
              ...
              @foreach($data_user_cabangs as $row)
              <label class="list-group-item">
                <span class="form-check mb-0">
        ...
        <div class="col-lg-6 p-6 pt-0">
          <small class="fw-medium">Daftar Cabang Yang Ada Pada Sistem</small>
          <div class="demo-inline-spacing mt-4">
            <div class="list-group">
              <label class="list-group-item">
                <span class="form-check mb-0">
