...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/merek-kendaraan.js') }}"></script>
@endsection
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-merek-kendaraan table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="filter-merek-kendaraan" class="form-control form-control-sm text-uppercase" maxlength="30" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('merek-kendaraan-list') }}">
            @csrf
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-merek-kendaraan" class="form-control form-control-sm text-uppercase" name="nama_merek" maxlength="30" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
