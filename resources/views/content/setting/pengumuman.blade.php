...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable">
      <table class="datatables-pengumuman table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="filter-startdate" class="form-control form-control-sm dt-date" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-notes">Isi Pengumuman</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-notes" class="form-control form-control-sm" />
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('pengumuman-list') }}">
            @csrf
            <input type="hidden" name="id" id="user_id">
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-startdate">Tanggal Mulai</label>
                ...
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-notes">Isi Pengumuman</label>
                  <div class="col-sm-9 form-control-validation">
                    <textarea class="form-control h-px-100 is-invalid" id="add-notes" name="notes"></textarea>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-enddate">Tanggal Akhir</label>
                  <div class="col-sm-9 form-control-validation">
