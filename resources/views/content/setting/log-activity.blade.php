...
@section('page-script')
    <script src="{{ asset('assets/js/log-activity.js') }}"></script>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="filterForm" class="form-control-validation" method="post"
                        action="{{ url('log-activity-list') }}" autocomplete="off">
                        @csrf
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Log Activity</h5>
                    </div>
                </div>
                <div class="card-datatable">
                    <table class="datatables-log-activity table table-bordered table-responsive"
                        data-title="{{ $title }}">
                        <thead>
                            <tr>
                                <th>No</th>
