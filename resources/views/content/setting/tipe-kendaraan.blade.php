...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/tipe-kendaraan.js') }}"></script>
@endsection
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-tipe-kendaraan table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="filter-tipe-kendaraan" class="form-control text-uppercase" maxlength="30" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-merek-kendaraan">Merek Kendaraan</label>
                  <div class="col-sm-9">
                    <select id="filter-merek-kendaraan" class="select2 form-select form-select-sm">
              ...
              <div class="col-md-6">
                ...
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9">
                    <select id="filter-jenis-kendaraan" class="select2 form-select form-select-sm">
                      <option value="all">Pilih Semua</option>
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('tipe-kendaraan-list') }}">
            @csrf
            <input type="hidden" name="id" id="user_id">
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-merek-kendaraan">Merek Kendaraan</label>
                  <div class="col-sm-9 form-control-validation">
                    <select id="add-merek-kendaraan" name="kode_merek" class="select2 form-select form-select-sm">
                ...
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-tipe-kendaraan" class="form-control text-uppercase" name="nama_tipe" maxlength="50" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9 form-control-validation">
                    <select id="add-jenis-kendaraan" name="kode_jenis" class="select2 form-select form-select-sm">
