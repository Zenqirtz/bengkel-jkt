...
@section('page-script')
    <script src="{{ asset('assets/js/login-activity.js') }}"></script>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="filterForm" class="form-control-validation" method="post"
                        action="{{ url('login-activity-list') }}" autocomplete="off">
                        @csrf

                        {{-- Tanggal --}}
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label" for="filter-tgl-awal">Tanggal Login</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" id="filter-tgl-awal" name="tgl_awal"
                                        class="form-control dt-date"
                                        value="{{ @$datafilter['tgl_awal'] }}"
                                        placeholder="Tanggal Awal" />
                                    <span class="input-group-text">s/d</span>
                                    <input type="text" id="filter-tgl-akhir" name="tgl_akhir"
                                        class="form-control dt-date"
                                        value="{{ @$datafilter['tgl_akhir'] }}"
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Login Activity</h5>
                    </div>
                </div>
                <div class="card-datatable">
                    <table class="datatables-login-activity table table-bordered table-responsive"
                        data-title="{{ $title }}">
                        <thead>
                            <tr>
                                <th>No</th>
