...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-rekening table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
        ...
        <div class="modal-body">
          <form id="formCariData" onsubmit="return false">
            <div class="row g-2">
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-bank">Nama Bank</label>
                  <div class="col-sm-9">
                    <select id="filter-bank" class="select2 form-select form-select-sm" data-allow-clear="true">
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('rekening-list') }}">
            @csrf
            ...
            <div class="row g-2">
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-bank">Nama Bank</label>
                  <div class="col-sm-9 form-control-validation">
                    <select id="add-bank" name="kode_bank" class="select2 form-select form-select-sm" data-allow-clear="true">
