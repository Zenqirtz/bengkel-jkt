...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-bank table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-nomor-rekening">Nomor Rekening</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-nomor-rekening" class="form-control form-control-sm text-number" maxlength="20" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-nama-bank">Nama Bank</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-nama-bank" class="form-control form-control-sm text-uppercase" maxlength="50" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-lokasi-bank">KCP</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-lokasi-bank" class="form-control form-control-sm text-uppercase" maxlength="100" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('bank-list') }}">
            @csrf
            <input type="hidden" name="id" id="user_id">
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-nomor-rekening">Nomor Rekening</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-nomor-rekening" name="no_rekening" class="form-control form-control-sm text-number" maxlength="20" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-nama-bank">Nama Bank</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-nama-bank" name="nama_bank" class="form-control form-control-sm text-uppercase" maxlength="50" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-lokasi-bank">KCP</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-lokasi-bank" name="lokasi_bank" class="form-control form-control-sm text-uppercase" maxlength="100" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
