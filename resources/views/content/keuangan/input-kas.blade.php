...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/input-kas.js') }}"></script>
@endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-datatable text-nowrap">
            <table class="datatables-ik table table-bordered" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}"
                data-delete="{{ $isDel }}">
                <thead>
                    <tr>
                        {{-- <th></th> --}}
                        <th><input type="checkbox" id="selectAllIK" class="form-check-input"></th>
                        <th>Tanggal</th>
                        <th>No. Voucher</th>
                        <th>Jenis</th>
                        <th>Transaksi</th>
    ...
    {{-- ================================================================
         ...
         Perbedaan dengan Input Bank: TIDAK ada pilihan Bank & No. Rekening
    ================================================================ --}}
    <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addNewDataForm" method="post" action="{{ url('input-kas-list') }}">
                        @csrf
                        <input type="hidden" name="id" id="ik_id">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                {{-- Tidak ada Bank & No. Rekening (beda dengan Input Bank) --}}
                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-1 align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="add-nilai" name="nilai" {{-- class="form-control form-control-sm text-end input-readonly" readonly> --}}
    ...
    {{-- ================================================================
 MODAL DETAIL INPUT KAS (READ-ONLY)
  ================================================================ --}}
