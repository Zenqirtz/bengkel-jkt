...
@section('page-script')
  <script src="{{ asset('assets/js/laporan-ch-bg-belum-kliring.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-ch-bg-belum-kliring-list') }}" autocomplete="off">
            @csrf
            {{-- Kategori --}}
            <div class="row mb-4">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-datatable text-nowrap">
        <table class="datatables-ch-bg-belum-kliring table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
          <thead>
            <tr>
                <th>No</th>
