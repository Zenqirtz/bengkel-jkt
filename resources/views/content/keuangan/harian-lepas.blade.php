...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/harian-lepas.js') }}"></script>
@endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-datatable text-nowrap">
            <table class="datatables-hl table table-bordered table-responsive" data-title="{{ $title }}"
                data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
                <thead>
                    <tr>
                        {{-- <th></th> --}}
                        <th><input type="checkbox" id="selectAllHL" class="form-check-input"></th>
                        <th>Tanggal</th>
                        <th>Nomor Transaksi</th>
                        <th>Jenis Pekerjaan</th>
                        <th>Nama Pekerja</th>
                        <th>Keluar Kas/Bank</th>
                        <th>No. Rekening</th>
                    ...
                    <form id="formCariData" onsubmit="return false">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="filter-nama">Nama Pekerja</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-6">
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="filter-jenis">Jenis Pekerjaan</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="filter-kode-bank">Keluar Kas/Bank</label>
                                    <div class="col-sm-9">
    ...
    <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="pt-0" id="addNewDataForm" method="post" action="{{ url('harian-lepas-list') }}">
                        @csrf
                        <input type="hidden" name="id" id="hl_id">
                        <input type="hidden" name="details" id="hl_details">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="add-jenis">Jenis Pekerjaan</label>
                                    <div class="col-sm-9 form-control-validation">
                                        <select id="add-jenis" name="jenis_pekerjaan" class="select2 form-select"
                                ...
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label">Nama Pekerja</label>
                                    <div class="col-sm-9 form-control-validation">
                                        <input type="hidden" id="add-kode-karyawan" name="kode_karyawan" />
                                        <input type="hidden" id="add-nama-pekerja" name="nama_pekerja" />
                                        <select id="add-select-pekerja" class="form-select"></select>
                                    </div>
                                </div>
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="add-kode-bank">Keluar Kas/Bank</label>
                                    <div class="col-sm-9 form-control-validation">
                                        <select id="add-kode-bank" name="kode_bank" class="select2 form-select"
                                            data-allow-clear="true">
                                            <option value="">Pilih Keluar Kas/Bank</option>
                                            @foreach ($bank as $b)
                                                <option value="{{ $b->kode_bank }}">{{ $b->nama_bank }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-1 align-items-center">
                                    ...
                                    <div id="wrap-no-rekening" class="col-sm-9 form-control-validation">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h6 class="mb-0">List Pembayaran SPK</h6>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-bordered" id="tbl-detail-spk">
                                <thead>
                                    <tr>
                                        ...
                                        {{-- <th style="width:150px" class="text-center">Sisa Upah Kerja</th>
                                        <th class="text-center">Progres Kerja</th> --}}
                                        <th class="text-end">Upah Kerja Awal</th>
                                        <th class="text-center">Progress Kerja Awal</th>
                                ...
                                <tbody id="tbody-detail-spk">
                                    <tr id="row-no-data">
                                        {{-- <td colspan="8" class="text-center text-muted py-2">Belum ada SPK ditambahkan --}}
                                        <td colspan="10" class="text-center text-muted py-2">Belum ada SPK ditambahkan
                                        </td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold" id="tfoot-total">0</td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                            </table>
    ...
    <div class="modal" id="modalPilihSpk" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Pilih SPK - Upah Kerja Harian Lepas</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="text-nowrap">
                        <table class="datatables-spk-hl table table-bordered table-responsive">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>No. SPK</th>
                                    ...
                                    <th>No. Polisi</th>
                                    {{-- <th>Nama Pemilik</th> --}}
                                    <th class="text-end">Upah Kerja</th>
                                    <th class="text-center">Progres Kerja</th>
                                    <th class="text-end">Total</th>
                                </tr>
                            </thead>
