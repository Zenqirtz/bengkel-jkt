...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/pembayaran-gabungan.js') }}"></script>
@endsection
...
@section('content')
                    ...
                    <form id="formCariData" onsubmit="return false">
                        <div class="row g-2">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="filter-nama">Nama Supplier</label>
                                    <div class="col-sm-9">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="pt-0" id="addNewDataForm" method="post"
                        action="{{ url('pembayaran-gabungan-list') }}">
                        @csrf
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-1 align-items-center">
                                    ...
                                    <div class="col-sm-9 form-control-validation">
                                        <input type="hidden" id="add-kode-pemasok" name="kode_pemasok" />
                                        <input type="hidden" id="add-nama-supplier" name="nama_supplier" />
                                        <select id="add-select-supplier" class="form-select"></select>
                                    </div>
                                </div>
                                <div class="row mb-1 align-items-center">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h6 class="mb-0">List Pembayaran</h6>
                            <button type="button" class="btn btn-sm btn-outline-primary" id="btn-pilih-ig">
                                <i class="ri-add-line"></i> Pilih IG
                            </button>
                        </div>

                        <div class="table-responsive">
                            <table class="table table-sm table-bordered" id="tbl-detail-ig">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="tbody-detail-ig">
                                    <tr id="row-no-data">
                                        <td colspan="5" class="text-center text-muted py-2">Belum ada IG ditambahkan
                                        </td>
                                    </tr>
                                </tbody>
                                <tfoot>
    ...
    {{-- ===== MODAL POPUP PILIH IG ===== --}}
    <div class="modal" id="modalPilihIg" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="text-nowrap">
                        <table class="datatables-ig-pg table table-bordered table-responsive">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>Tanggal</th>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-primary" id="btn-tambah-ig-terpilih">Pilih</button>
                </div>
            </div>
        </div>
    </div>
    {{-- ===== END MODAL POPUP PILIH IG ===== --}}
