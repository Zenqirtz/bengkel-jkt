...
@section('content')
    <div class="paper">
        ...
        Beda dengan Input Bank: TIDAK ada kolom Bank/No. Rekening,
             karena Kas tidak melalui transfer bank
        <table class="tbl-detail">
            <thead>
                <tr>
                    <th style="width:15%;">No. Voucher</th>
                    <th style="width:28%;">Account/COA</th>
                    <th style="width:26%;">Uraian</th>
                    <th style="width:11%;">No. SPK</th>
                    <th style="width:11%;">No. Inv. Gabung</th>
            ...
            <tbody>
                @forelse ($details as $d)
                    <tr>
                        ...
                        <td class="text-center">{{ $d->no_inv_gabung }}</td>
        ...
        <div class="ttd-section">
            <div class="ttd-box">
                Dibuat Oleh
                <div class="ttd-paren">( <span class="ttd-name">&nbsp;</span> )</div>
            </div>
            <div class="ttd-box">
                Diperiksa Oleh
                <div class="ttd-paren">( <span class="ttd-name">&nbsp;</span> )</div>
                ...
                <table class="tableX table-borderless">
                    <thead class="border-bottom border-dark border-2">
                        <tr>
                            ...
                            <th style="width:25%;">Account/COA</th>
