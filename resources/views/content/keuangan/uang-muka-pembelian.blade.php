...
@section('page-script')
    ...
    <script src="{{ asset('assets/js/uang-muka-pembelian.js') }}"></script>
@endsection
...
@section('content')
    <div class="card">
        ...
        <div class="card-datatable text-nowrap">
            <table class="datatables-umb table table-bordered table-responsive" data-title="{{ $title }}"
                ...
                <div class="modal-body">
                    <form id="formCariData" onsubmit="return false">
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="filter-jenis">Jenis Pengeluaran</label>
                                    <div class="col-sm-9">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="add-new-user pt-0" id="addNewDataForm" method="post"
                        action="{{ url('uang-muka-pembelian-list') }}">
                        @csrf
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-1 align-items-center">
                                    <label class="col-sm-3 col-form-label" for="add-jenis">Jenis Pengeluaran</label>
                                    <div class="col-sm-9 form-control-validation">
                                        <select id="add-jenis" name="jenis_pengeluaran" class="select2 form-select"
