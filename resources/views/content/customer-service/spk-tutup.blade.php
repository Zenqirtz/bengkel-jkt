...
@section('page-script')
  ...
  <script src="{{ asset('assets/js/spk-tutup.js') }}"></script>
@endsection
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
      ...
      <div class="demo-inline-spacing">
        ...
        <button type="button" class="btn btn-primary edit-selected-spk">SPK Tutup</button>
      </div>
    </div>
        ...
        <div class="modal-body">
          <div id="wizard-property-listing" class="bs-stepper vertical mt-2">
            <div class="bs-stepper-header gap-lg-2 border-end">
              ...
              <div class="step" data-target="#property-details">
                <button type="button" class="step-trigger">
                  ...
                  <span class="bs-stepper-label">
                    <span class="d-flex flex-column ms-2">
                      <span class="bs-stepper-title">SPK Tutup</span>
                    </span>
                  </span>
                </button>
              </div>
            ...
            <div class="bs-stepper-content">
              <form id="wizard-property-listing-form" method="post" action="{{ url('spk-tutup-list') }}" onSubmit="return false">
                @csrf
                ...
                <div id="property-details" class="content">
                  <div class="row g-5">
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-nomor-tutup" name="kode_tutup" class="form-control input-readonly is-invalid" readonly />
                        <label for="add-nomor-tutup">Nomor Tutup</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-tgl-tutup" name="tanggal_tutup" class="form-control dt-date is-invalid" />
                        <label for="add-tgl-tutup">Tanggal Tutup</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-turun" name="kode_turun_lapangan" class="form-control" disabled />
                        <label for="add-turun">Nomor Turun Lap.</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-tgl-turun" name="tgl_turun_lapangan" class="form-control dt-date" disabled />
                        <label for="add-tgl-turun">Tanggal Turun Lap.</label>
                      </div>
                    </div>
