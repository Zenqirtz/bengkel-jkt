...
@section('page-script')
  ...
  <script src="{{ asset('assets/js/tanda-terima-invoice-or.js') }}"></script>
@endsection
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-spk table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            {{-- <th></th> --}}
            <th><input type="checkbox" id="selectAllInvoice" class="form-check-input"></th>
            <th>No</th>
            <th>Tgl Invoice</th>
            <th>No. Invoice</th>
            <th>Tgl SPK</th>
                ...
                <div id="property-details" class="content">
                  <div class="row g-5">
                    <div class="col-sm-12 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-nomor-invoice" name="no_invoice" class="form-control input-readonly is-invalid" readonly />
                        <label for="add-nomor-invoice">Nomor Invoice</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-tgl-invoice" name="tgl_invoice" class="form-control dt-date" />
                        <label for="add-tgl-invoice">Tanggal Invoice</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-nilai" name="nilai_or" class="form-control invoice-price" />
                        <label for="add-nilai">Nilai</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <select id="add-or-fee" name="ada_or" class="select2 form-select" data-allow-clear="true">
                    ...
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-nilai2" name="total_or" class="form-control invoice-price" />
        ...
        <div class="modal-body">
          <form id="formFilterSpk" onsubmit="return false">
            <div class="row g-4">
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-3 col-form-label text-sm-end" for="filter-no-polis">Nomor Invoice</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-no-invoice" class="form-control" name="no_invoice" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-3 col-form-label text-sm-end" for="filter-tgl-invoice-awal">Tanggal Invoice</label>
                  <div class="col-sm-9">
                    <div class="input-group">
                      <input type="text" id="filter-tgl-invoice-awal" class="form-control dt-date" name="tgl_invoice_awal" />
                      <span class="input-group-text">s/d</span>
                      <input type="text" id="filter-tgl-invoice-akhir" class="form-control dt-date" name="tgl_invoice_akhir" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    ...
                    <select id="filter-nama-pelanggan" class="select2 form-select" data-allow-clear="true">
              ...
              <div class="col-md-6">
                <div class="row">
                  ...
                  <div class="col-sm-9">
                    ...
                    <select id="filter-nama-pemilik" class="select2 form-select" data-allow-clear="true">
                      <option value="all">Pilih Semua</option>
                      @foreach($pemilik as $row)
                        <option value="{{ $row->nama_pemilik }}">{{ $row->nama_pemilik }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
