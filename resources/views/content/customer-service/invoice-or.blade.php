...
@section('page-script')
  ...
  <script src="{{ asset('assets/js/invoice-or.js') }}"></script>
@endsection
...
@section('content')
    ...
    <div class="card-header d-flex align-items-center justify-content-between">
      <div class="card-title mb-0">
       ...
       <div class="demo-inline-spacing">
        ...
        <button type="button" class="btn btn-primary edit-selected-spk">Invoice OR</button>
        <button type="button" class="btn btn-primary cetak-invoice">Cetak</button>
        {{-- <button type="button" class="btn btn-primary cetak-invoice-filter" data-bs-toggle="modal" data-bs-target="#cetakFilterModal">Filter</button> --}}
      </div>
    </div>
        ...
        <div class="modal-body">
          <div id="wizard-property-listing" class="bs-stepper vertical mt-2">
            <div class="bs-stepper-header gap-lg-2 border-end">
              ...
              <div class="step" data-target="#property-details">
                <button type="button" class="step-trigger">
                  ...
                  <span class="bs-stepper-label">
                    <span class="d-flex flex-column ms-2">
                      <span class="bs-stepper-title">Invoice OR</span>
                    </span>
                  </span>
                </button>
              </div>
            ...
            <div class="bs-stepper-content">
              <form id="wizard-property-listing-form" method="post" action="{{ url('invoice-or-list') }}" onSubmit="return false">
                @csrf
                ...
                <div id="property-details" class="content">
                  <div class="row g-5">
                    <div class="col-sm-12 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-nomor-invoice" name="no_invoice" class="form-control" disabled />
                        <label for="add-nomor-invoice">Nomor Invoice</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-tgl-invoice" name="tgl_invoice" class="form-control dt-date is-invalid" />
                        <label for="add-tgl-invoice">Tanggal Invoice</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-nilai" name="nilai_or" class="form-control invoice-price" disabled />
                        <label for="add-nilai">Nilai</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <select id="add-or-fee" name="is_free" class="select2 form-select" data-allow-clear="true" disabled>
                          {{-- <option value="">Pilih OR Fee</option> --}}
                          <option value="01">YA</option>
                          <option value="02">TIDAK</option>
                        </select>
                        <label for="add-or-fee">OR Fee</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-nilai2" name="total_or" class="form-control invoice-price" disabled />
                        <label for="add-nilai2">Nilai</label>
                      </div>
                    </div>
  ...
  <!--/ Add CARI SPK Modal -->
  <!-- Modal Filter Cetak Invoice OR Per Pelanggan -->
  <div class="modal" id="cetakFilterModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Cetak Invoice OR Per Pelanggan</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="formCetakFilter" onsubmit="return false">
            <div class="row g-4">
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-end" for="cetak-nama-pelanggan">Nama Pelanggan</label>
                  <div class="col-sm-8">
                    <input type="text" id="cetak-nama-pelanggan" class="form-control" name="nama_pelanggan" placeholder="Kosongkan untuk semua" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-end" for="cetak-nomor-spk">Nomor SPK</label>
                  <div class="col-sm-8">
                    <input type="text" id="cetak-nomor-spk" class="form-control" name="kode_spk" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-end" for="cetak-no-polisi">Nomor Polisi</label>
                  <div class="col-sm-8">
                    <input type="text" id="cetak-no-polisi" class="form-control" name="no_polisi" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-end" for="cetak-no-polis">Nomor Polis</label>
                  <div class="col-sm-8">
                    <input type="text" id="cetak-no-polis" class="form-control" name="no_polis" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-end" for="cetak-tgl-invoice-awal">Tgl Invoice</label>
                  <div class="col-sm-8">
                    <input type="text" id="cetak-tgl-invoice-awal" class="form-control dt-date" name="tgl_invoice_awal" placeholder="dd/mm/yyyy" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-center" for="cetak-tgl-invoice-akhir">s/d</label>
                  <div class="col-sm-8">
                    <input type="text" id="cetak-tgl-invoice-akhir" class="form-control dt-date" name="tgl_invoice_akhir" placeholder="dd/mm/yyyy" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-end" for="cetak-no-klaim">Nomor Klaim</label>
                  <div class="col-sm-8">
                    <input type="text" id="cetak-no-klaim" class="form-control" name="kode_claim" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="row">
                  <label class="col-sm-4 col-form-label text-sm-end" for="cetak-status-spk">Status SPK</label>
                  <div class="col-sm-8">
                    <select id="cetak-status-spk" class="select2 form-select" name="status_spk" data-allow-clear="true">
                      <option value="all">Pilih Semua</option>
                      @foreach($status_spk as $row)
                        <option value="{{ $row->kode }}">{{ $row->keterangan }}</option>
                      @endforeach
