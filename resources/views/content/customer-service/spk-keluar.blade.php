...
@section('page-script')
  ...
  <script src="{{ asset('assets/js/spk-keluar.js') }}"></script>
@endsection
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
      ...
      <div class="demo-inline-spacing">
        ...
        <button type="button" class="btn btn-primary edit-selected-spk">SPK Keluar</button>
        <button type="button" class="btn btn-primary cetak-kendaraan-keluar">Cetak</button>
      </div>
    </div>
        ...
        <div class="modal-body">
          <div id="wizard-property-listing" class="bs-stepper vertical mt-2">
            ...
            <div class="bs-stepper-content">
              <form id="wizard-property-listing-form" method="post" action="{{ url('spk-keluar-list') }}" onSubmit="return false">
                @csrf
                ...
                <div id="property-details" class="content">
                  <div class="row g-5">
                    ...
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-penerima" name="nama_penerima" class="form-control text-uppercase is-invalid" maxlength="50" />
                        <label for="add-penerima">Nama Penerima</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-tgl-terima" name="tgl_tanda_terima" class="form-control dt-date is-invalid" />
                        <label for="add-tgl-terima">Tanggal Terima</label>
                      </div>
                    </div>
                    <div class="col-sm-6 form-control-validation">
                      <div class="form-floating form-floating-outline">
                        <input type="text" id="add-pengantar" name="nama_pengantar" class="form-control text-uppercase" maxlength="50" />
                        <label for="add-pengantar">Nama Pengantar</label>
                      </div>
                    </div>
