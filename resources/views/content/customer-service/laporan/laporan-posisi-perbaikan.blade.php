...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/laporan-posisi-perbaikan.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-posisi-perbaikan-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
...
@if (@$datafilter['jenis_laporan'])
<div class="row mt-5">
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="card-title mb-0">
          <h5 class="m-0 me-2">Laporan Posisi Perbaikan di Lapangan</h5>
        </div>
      ...
      <div class="card-datatable">
        <table class="datatables-posisi-perbaikan table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
          <thead>
            <tr>
              <th>No</th>
              <th>No. SPK</th>
