...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/laporan-outstanding.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-outstanding-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
...
@if (@$datafilter['jenis_laporan'] == "periode")
  @include('content/customer-service/laporan/laporan-outstanding-periode')
@elseif (@$datafilter['jenis_laporan'] == "tahun")
  @include('content/customer-service/laporan/laporan-outstanding-tahun')
@endif
