...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/laporan-kwitansi.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-kwitansi-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
...
@if (@$datafilter['jenis_laporan'] == "periode")
  @include('content/customer-service/laporan/laporan-kwitansi-periode')
@elseif (@$datafilter['jenis_laporan'] == "tahun")
  @include('content/customer-service/laporan/laporan-kwitansi-tahun')
@endif
