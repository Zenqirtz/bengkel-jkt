...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/laporan-spk.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-spk-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
         ...
         <div class="row mb-4">
            <label class="col-sm-2 col-form-label" for="filter-nama-customer">Customer / Tertanggung</label>
            <div class="col-sm-10">
              <select id="filter-nama-customer" name="nama_customer" class="select2 form-select" style="width: 100%;">
                <option value="">-- Semua Customer --</option>
                @foreach($customerList as $customer)
                  <option value="{{ $customer }}"
                    @if(old('nama_customer', @$datafilter['nama_customer']) == $customer) selected @endif>
                    {{ $customer }}
                  </option>
                @endforeach
              </select>
...
@if (@$datafilter['tipe_laporan'] == "spk")
  @include('content/customer-service/laporan/laporan-spk-master')
@elseif (@$datafilter['tipe_laporan'] == "spk_tutup")
  @include('content/customer-service/laporan/laporan-spk-tutup')
@elseif (@$datafilter['tipe_laporan'] == "spk_batal")
  @include('content/customer-service/laporan/laporan-spk-batal')
@elseif (@$datafilter['tipe_laporan'] == "spk_keluar")
  @include('content/customer-service/laporan/laporan-spk-keluar')
@endif
