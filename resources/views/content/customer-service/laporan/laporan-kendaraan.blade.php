...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/laporan-kendaraan.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-kendaraan-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
...
@if (@$datafilter['tipe_laporan'] == "mobil_masuk")
  @include('content/customer-service/laporan/laporan-kendaraan-masuk')
@elseif (@$datafilter['tipe_laporan'] == "mobil_belum_turun")
  @include('content/customer-service/laporan/laporan-kendaraan-belum-turun-lapangan')
@elseif (@$datafilter['tipe_laporan'] == "mobil_turun")
  @include('content/customer-service/laporan/laporan-kendaraan-turun-lapangan')  
@endif
