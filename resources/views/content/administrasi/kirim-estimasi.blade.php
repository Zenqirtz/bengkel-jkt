...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/kirim-estimasi.js') }}"></script>
@endsection
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="kode_pengiriman" id="kode_pengiriman">
          ...
          <div class="row g-2">
            ...
            <div class="col-md-6">
              ...
              <div class="row mb-1 align-items-center">
                ...
                <div class="col-sm-9 form-control-validation">
                  <input type="text" id="add-nomor-pengiriman" name="kode_pengiriman2" class="form-control form-control-sm text-primary fw-bold" disabled />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
                <label class="col-sm-3 col-form-label">Tanggal Kirim</label>
                <div class="col-sm-9 form-control-validation">
                  <input type="text" id="add-tanggal-kirim" name="tgl_pengiriman" class="form-control form-control-sm dt-date" />
                </div>
              </div>
              <div class="row mb-1">
                <label class="col-sm-3 col-form-label">Nama Pengirim</label>
                <div class="col-sm-9 form-control-validation">
                  <input type="text" id="add-nama-pengirim" name="pengirim" class="form-control form-control-sm text-uppercase" />
                </div>
              </div>
              {{-- <div class="row mb-1">
                <label class="col-sm-3 col-form-label">Nama Penerima</label>
                <div class="col-sm-9 form-control-validation">
                  <input type="text" id="add-nama-penerima" name="penerima" class="form-control form-control-sm" />
                </div>
              </div> --}}
            </div>
          </div>
