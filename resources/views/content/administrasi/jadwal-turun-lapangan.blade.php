...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/jadwal-turun-lapangan.js') }}"></script>
@endsection
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addNewDataForm" method="post" action="{{ url('jadwal-turun-lapangan-list') }}" onSubmit="return false">
          @csrf
          ...
          <div class="row g-2">
            ...
            <div class="col-md-6">
              ...
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Tgl Turun Lap.</label>
                <div class="col-sm-8 form-control-validation">
                  <input type="text" id="add-tanggal-turun-lapangan" name="tgl_turun_lapangan" class="form-control form-control-sm is-invalid" />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Tgl Rencana Selesai</label>
                <div class="col-sm-8 form-control-validation">
                  <input type="text" id="add-tanggal-rencana-selesai" name="tgl_rencana_selesai" class="form-control form-control-sm is-invalid" />
                </div>
              </div>
              <div class="row mb-1">
                <label class="col-sm-4 col-form-label">Yang Menyerahkan</label>
                <div class="col-sm-8 form-control-validation">
                  {{-- <input type="text" id="add-yang-menyerahkan" name="yang_menyerahkan" class="form-control form-control-sm is-invalid" /> --}}
                  <select id="add-yang-menyerahkan" name="yang_menyerahkan" class="select2 form-select is-invalid" data-allow-clear="true">
                    <option value="">Pilih Yang Menyerahkan</option>
                    @foreach($pic_menyerahkan as $row)
              ...
              <div class="row mb-1">
                ...
                <div class="col-sm-8 form-control-validation">
                  {{-- <input type="text" id="add-yang-menerima" name="yang_menerima" class="form-control form-control-sm is-invalid" /> --}}
                  <select id="add-yang-menerima" name="yang_menerima[]" class="select2 form-select is-invalid" data-allow-clear="true" multiple>
                    {{-- <option value="">Pilih Yang Menerima</option> --}}
                    @foreach($pic_menerima as $row)
                      <option value="{{ $row->kode_karyawan }}">{{ $row->nama }}</option>
                    @endforeach
                  </select>
                </div>
              ...
              <div class="row mb-1 align-items-center">
                ...
                <div class="col-sm-8 form-control-validation">
                  <input type="text" id="add-tanggal-terima" name="tgl_terima" class="form-control form-control-sm is-invalid" />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Keterangan</label>
                <div class="col-sm-8 form-control-validation">
                  <textarea id="add-keterangan" name="keterangan" class="form-control form-control-sm" style="height: 100px;"></textarea>
                </div>
              </div>
              {{-- RAWAT JALAN --}}
              <div class="row mb-1 align-items-center">
              <label class="col-sm-4 col-form-label">Ada Rawat Jalan?</label>
              <div class="col-sm-8 form-control-validation">
                <div class="form-check mt-2">
                  <input class="form-check-input" type="checkbox" id="add-ada-rawat-jalan"
                        name="ada_rawat_jalan" value="1" />
                  <label class="form-check-label" for="add-ada-rawat-jalan">
                    Ya, kendaraan ini perlu rawat jalan
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="row g-2 mt-3">
            <div class="col-md-12">
              <div class="table-responsive">
                <table class="datatables-perbaikan table table-bordered">
                  <thead>
                    <tr>
                      <th width="5%">No</th>
                  ...
                  <tfoot>
                    <tr>
                        <th colspan="3" style="text-align:right">Total Point Panel</th>
                        <th><span id="disp-jumlah-panel">0.00</span><input type="hidden" name="jumlah_panel" id="add-jumlah-panel"></th>
                        <th></th>
                    </tr>
                  </tfoot>
                </table>
