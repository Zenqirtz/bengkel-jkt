...
@section('page-script')
  <script src="{{ asset('assets/js/laporan-komisi-surveyor.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-komisi-surveyor-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="card-title mb-0">
          <h5 class="m-0 me-2">Laporan Komisi Surveyor</h5>
        </div>
      ...
      <div class="card-datatable">
        <table class="datatables-komisi-surveyor table table-bordered table-responsive" data-title="{{ $title }}"
