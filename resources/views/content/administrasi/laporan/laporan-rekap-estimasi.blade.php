...
@section('page-script')
  <script src="{{ asset('assets/js/laporan-rekap-estimasi.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-rekap-estimasi-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="card-title mb-0">
          <h5 class="m-0 me-2">Laporan Rekap Estimasi</h5>
        </div>
      ...
      <div class="card-datatable text-nowrap">
        <table class="datatables-rekap-estimasi table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
          <thead>
            <tr>
              <th rowspan="2">No</th>
              ...
              <th colspan="3" class="text-center">Sparepart</th>
          ...
          <tfoot>
            <tr>
              ...
              <th id="footer-unit" class="text-center">0</th>
              <th id="footer-perbaikan-r" class="text-end">0</th>
              <th id="footer-perbaikan-s" class="text-end">0</th>
              <th id="footer-perbaikan-t" class="text-end">0</th>
              <th id="footer-sparepart-r" class="text-end">0</th>
              <th id="footer-sparepart-s" class="text-end">0</th>
              <th id="footer-sparepart-t" class="text-end">0</th>
              <th id="footer-lain-r" class="text-end">0</th>
              <th id="footer-lain-s" class="text-end">0</th>
              <th id="footer-lain-t" class="text-end">0</th>
              <th id="footer-ppn" class="text-end">0</th>
              <th id="footer-total" class="text-end">0</th>
            </tr>
          </tfoot>
        </table>
      </div>
