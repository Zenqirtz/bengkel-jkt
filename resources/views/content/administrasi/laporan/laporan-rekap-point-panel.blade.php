...
@section('page-script')
  <script src="{{ asset('assets/js/laporan-rekap-point-panel.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-rekap-point-panel-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="card-title mb-0">
          <h5 class="m-0 me-2">Laporan Rekap Point Panel</h5>
        </div>
      ...
      <div class="card-datatable">
        <table class="datatables-rekap-point-panel table table-bordered table-responsive" data-title="{{ $title }}"
          ...
          <tfoot>
            <tr>
              <th colspan="2"></th>
              <th id="footer-jumlah-spk" class="text-end">0</th>
              <th id="footer-total-panel" class="text-end">0</th>
            </tr>
          </tfoot>
        </table>
      </div>
