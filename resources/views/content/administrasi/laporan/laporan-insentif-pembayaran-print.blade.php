    ...
    <div class="invoice-print p-12">
        <div class="d-flex justify-content-between flex-row">
            <div class="mb-6">
                ...
                <p class="mb-1">Laporan Insentif Pembayaran</p>
                ...
                <tbody>
                    ...
                    @foreach ($datas as $row)
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{ blank($row->tgl_lunas) ? '' : date('d/m/Y', strtotime($row->tgl_lunas)) }}
                            </td>
                            <td class="text-center">
                                {{ blank($row->tgl_kwitansi) ? '' : date('d/m/Y', strtotime($row->tgl_kwitansi)) }}
                            </td>
                    ...
                    @if (count($datas) > 0)
                        <tr>
                            ...
                            <td class="text-end fw-bold">{{ number_format($totalJasa, 0, ',', '.') }}</td>
                            <td class="text-end fw-bold">{{ number_format($totalSparepart, 0, ',', '.') }}</td>
