...
@section('page-script')
  <script src="{{ asset('assets/js/laporan-estimasi-disetujui.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-estimasi-disetujui-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
...
<div class="row mt-5">
  <div class="col-12">
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="card-title mb-0">
          <h5 class="m-0 me-2">Laporan Estimasi Disetujui</h5>
        </div>
    ...
    <table class="datatables-estimasi-disetujui table table-bordered table-responsive" data-title="{{ $title }}"
        data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
          <thead>
            <tr>
              ...
              <th colspan="4" class="text-center">Estimasi Belum Ditawar</th>
              <th colspan="4" class="text-center">Estimasi Disetujui</th>
