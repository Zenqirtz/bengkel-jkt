        ...
        <thead>
            <tr>
              <th colspan="22" style="border: none !important; text-align: left; padding-bottom: 20px; background: #fff;"> 
                ...
                <div style="font-weight: bold; font-size: 18px;">Laporan Rekap Estimasi Belum Ditawar [Outstanding Penawaran]</div>
    ...
    @foreach ($datas as $nama_pelanggan => $tmp)
            ...
            <thead>
                <tr>
                    <th style="border: none !important; text-align: left; padding-bottom: 10px; background: #fff;"> 
                        <div style="font-weight: bold; font-size: 18px;">{{ $namaCabang }}</div>
                        <div style="font-weight: bold; font-size: 18px;">Laporan Rincian Estimasi Belum Ditawar [Outstanding Penawaran]</div>
                        <div style="font-weight: normal; font-size: 14px;">Periode : {{ $periodeStr ?? '' }}</div>
                    </th>
                </tr>
                <tr>
        ...
        @foreach ($tmp as $minggu => $rows)
            ...
            <thead>
                <tr>
                    <th width="50">No</th>
                    <th width="100">Tanggal<br>Estimasi</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ blank($rowdet['tanggal']) ? '' : date("d/m/Y", strtotime($rowdet['tanggal'] ))}}</td>
                    <td>{{ $rowdet['kode_estimasi'] }}</td>
