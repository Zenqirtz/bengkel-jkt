...
<!-- Page Scripts -->
@section('page-script')
  <script src="{{ asset('assets/js/terima-dokumen-klaim.js') }}"></script>
@endsection
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addNewDataForm" method="post" action="{{ url('terima-dokumen-klaim-list') }}" onSubmit="return false">
          @csrf
          ...
          <div class="row g-2 mt-3">
            <div class="col-md-12">
              <h5 class="m-0 me-2 text-center fw-bold">Dokumen Checklist</h5>
              <div class="table-responsive">
                <table class="datatables-dokumen table table-bordered">
                  <thead>
                    <tr>
                      <th width="5%">No</th>
                      <th>Dokumen</th>
