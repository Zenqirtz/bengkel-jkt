...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-datatable text-nowrap">
      <table class="datatables-umum table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-nama-barang">Nama Barang</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-nama-barang" class="form-control form-control-sm text-uppercase" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9">
                    <select id="filter-jenis" class="select2 form-select form-select-sm" data-allow-clear="true">
                      <option value="all">Pilih Semua</option>
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('umum-list') }}">
            @csrf
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-nama-barang">Nama Barang</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-nama-barang" class="form-control form-control-sm text-uppercase" name="nama_barang" maxlength="50" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9 form-control-validation">
                    <select id="add-jenis" name="kode_jenis" class="select2 form-select form-select-sm" data-allow-clear="true">
                ...
                {{-- <div class="row mb-1 align-items-center">
                  ...
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-harga" class="form-control form-control-sm invoice-price" name="price" />
                  </div>
                </div> --}}
              </div>
            </div>
