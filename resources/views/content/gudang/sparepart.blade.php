...
@section('page-script')
  ...
  <script src="{{ asset('assets/js/sparepart.js') }}"></script>
@endsection
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-nama-sparepart">Nama Sparepart</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-nama-sparepart" class="form-control form-control-sm text-uppercase" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-satuan-beli">Satuan</label>
                  <div class="col-sm-9">
  ...
  <div class="modal" id="addRoleModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="add-new-user pt-0" id="addNewDataForm" method="post" action="{{ url('sparepart-list') }}">
            @csrf
            ...
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-nama-sparepart">Nama Sparepart</label>
                  <div class="col-sm-9 form-control-validation">
                    <input type="text" id="add-nama-sparepart" class="form-control form-control-sm text-uppercase" name="nama_sparepart" maxlength="50" />
                  </div>
                </div>
                <div class="row mb-1 align-items-center">
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="add-satuan-beli">Satuan</label>
                  <div class="col-sm-9 form-control-validation">
