...
@section('page-script')
  ...
  <script src="{{ asset('assets/js/retur-pembelian.js') }}"></script>
@endsection
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-4 pb-sm-0">
              <div>
                ...
                <p class="mb-0">Menunggu Approval RG</p>
                <p class="mb-0"><small class="text-body-secondary">{{ date('Y') }}</small></p>
              </div>
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
      ...
      <div class="demo-inline-spacing">
        <button type="button" class="btn btn-primary filter-retur" data-bs-toggle="modal" data-bs-target="#filterRoleModal">Cari</button>
        @if ($isDel)
        <button type="button" class="btn btn-primary approve-selected-retur">Approve</button>
        @endif
        @if ($isAdd)
        <button type="button" class="btn btn-primary add-new" data-bs-toggle="modal" data-bs-target="#addRoleModal">Tambah</button>
        @endif
        @if ($isEdit)
        <button type="button" class="btn btn-primary edit-selected-retur">Ubah</button>
        @endif
        @if ($isDel)
        <button type="button" class="btn btn-primary delete-record">Hapus</button>
        @endif
        @if ($isAdd)
        <button type="button" class="btn btn-primary cetak-selected-retur">Cetak</button>
        @endif
      </div>
    </div>
    <div class="card-datatable text-nowrap">
      <table class="datatables-retur table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
            <th>Tanggal</th>
            <th>Nomor Retur Gudang</th>
            <th>Keterangan</th>
            <th>Nomor IG</th>
            <th>Nomor SPK</th>
            <th>Tipe Barang</th>
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addNewDataForm" method="post" action="{{ url('retur-pembelian-list') }}" onSubmit="return false">
          @csrf
          ...
          <div class="row g-2">
            <div class="col-md-6">
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Nomor IG</label>
                <div class="col-sm-5 form-control-validation">
                  <input type="text" id="add-nomor-input2" name="kode_input2" class="form-control form-control-sm text-primary fw-bold" disabled />
                </div>
                <div class="col-sm-3 form-control-validation">
                  <input type="text" id="add-tanggal-input" name="tgl_input" class="form-control form-control-sm text-primary" disabled />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
            ...
            <div class="col-md-6">
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Nomor Retur Gudang</label>
                <div class="col-sm-8 form-control-validation">
                  <input type="text" id="add-nomor-retur" name="no_retur" class="form-control form-control-sm text-primary fw-bold input-readonly" readonly />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Tanggal</label>
                <div class="col-sm-8 form-control-validation">
                  <input type="text" id="add-tanggal-retur" name="tanggal" class="form-control form-control-sm dt-date" value="{{ date('d/m/Y') }}" />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
                      ...
                      <table class="datatables-detail table table-bordered table-responsive">
                        ...
                        <tfoot>
                          <tr>
                              ...
                              <th><span id="total-barang">0</span></th>
                              <th></th>
                          </tr>
                        </tfoot>
                      </table>
        ...
        <div class="modal-body">
          <form id="formCariData" onsubmit="return false">
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-3 col-form-label" for="filter-nomor-order">Nomor Retur</label>
                  <div class="col-sm-9">
                    <input type="text" id="filter-nomor-retur" class="form-control form-control-sm text-uppercase" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
