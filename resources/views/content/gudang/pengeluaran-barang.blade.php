...
@section('page-script')
  ...
  <script src="{{ asset('assets/js/pengeluaran-barang.js') }}"></script>
@endsection
...
@section('content')
        ...
        <div class="row gy-4 gy-sm-1">
          <div class="col-sm-6 col-lg-4">
            <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-4 pb-sm-0">
              <div>
                <h4 class="mb-0" id="total-pb-pending">0</h4>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-4 pb-sm-0">
              <div>
                <h4 class="mb-0" id="total-pb-bulan">0</h4>
                <p class="mb-0">Pengeluaran Barang</p>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="d-flex justify-content-between align-items-start">
              <div>
                <h4 class="mb-0" id="total-pb-tahun">0</h4>
                <p class="mb-0">Pengeluaran Barang</p>
                <p class="mb-0"><small class="text-body-secondary">{{ date('Y') }}</small></p>
              </div>
              <div class="avatar me-sm-6">
  ...
  <div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
      ...
      <div class="demo-inline-spacing">
        <button type="button" class="btn btn-primary filter-pengeluaran" data-bs-toggle="modal" data-bs-target="#filterRoleModal">Cari</button>
        @if ($isDel)
        <button type="button" class="btn btn-primary approve-selected-pengeluaran">Approve</button>
        @endif
        @if ($isAdd)
        <button type="button" class="btn btn-primary add-new" data-bs-toggle="modal" data-bs-target="#addRoleModal">Tambah</button>
        @endif
        @if ($isEdit)
        <button type="button" class="btn btn-primary edit-selected-pengeluaran">Ubah</button>
        @endif
        @if ($isDel)
        <button type="button" class="btn btn-primary delete-record">Hapus</button>
        @endif
        @if ($isAdd)
        <button type="button" class="btn btn-primary cetak-selected-pengeluaran">Cetak</button>
        @endif
      </div>
    </div>
    <div class="card-datatable text-nowrap">
      <table class="datatables-pengeluaran table table-bordered table-responsive" data-title="{{ $title }}" data-add="{{ $isAdd }}" data-edit="{{ $isEdit }}" data-delete="{{ $isDel }}">
        <thead>
          <tr>
            <th></th>
            <th>No</th>
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="addNewDataForm" method="post" action="{{ url('pengeluaran-barang-list') }}" onSubmit="return false">
          @csrf
          ...
          <div class="row g-2" id="view-spk">
            <div class="col-md-6">
              <div class="row mb-1 align-items-center"> 
                <label class="col-sm-4 col-form-label" id="title-spk">Nomor Input Gudang</label>
          ...
          <div class="row g-2">
            <div class="col-md-6">
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Nomor Pengeluaran</label>
                <div class="col-sm-8">
                  <input type="text" id="add-nomor-pengeluaran" name="kode_pengeluaran" class="form-control form-control-sm text-primary fw-bold" disabled />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
                <label class="col-sm-4 col-form-label">Tanggal</label>
                <div class="col-sm-8 form-control-validation">
                  <input type="text" id="add-tanggal-pengeluaran" name="tanggal" class="form-control form-control-sm dt-date" value="{{ date('d/m/Y') }}" />
                </div>
              </div>
              <div class="row mb-1 align-items-center">
            ...
            <div class="col-md-6">
              {{-- <div class="row mb-1 align-items-center">
                ...
                <div class="col-sm-8 form-control-validation">
                  <input type="text" id="add-nomor-bon" name="no_bon" class="form-control form-control-sm" maxlength="20" />
                </div>
              </div> --}}
              <div class="row mb-1">
                  ...
                  <div class="tab-pane fade show active" id="navs-pills-top-barang" role="tabpanel">
                    ...
                    <div class="custom-table-container">
                      <table class="datatables-detail table table-bordered table-responsive">
                        ...
                        <tfoot>
                          <tr>
                            <th colspan="6" style="text-align:right" class="input-total">Total</th>
                            <th><span id="total-detail" class="input-total">0</span><input type="hidden" name="total_detail" id="add-total-detail"></th> 
                            <th></th>
                          </tr>
                        </tfoot>
                      </table>
        ...
        <div class="modal-body">
          <form id="formCariData" onsubmit="return false">
            <div class="row g-2">
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-4 col-form-label" for="filter-nomor-pengeluaran">Nomor Pengeluaran</label>
                  <div class="col-sm-8">
                    <input type="text" id="filter-nomor-pengeluaran" class="form-control form-control-sm text-uppercase" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-4 col-form-label" for="filter-nomor-permintaan">Nomor Input Gudang</label>
                  <div class="col-sm-8">
              ...
              <div class="col-md-6">
                ...
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-4 col-form-label text-sm-center" for="filter-tanggal-akhir">s/d</label>
                  <div class="col-sm-8">
                ...
                <div class="row mb-1 align-items-center">
                  <label class="col-sm-4 col-form-label" for="filter-status-approve">Status</label>
                  <div class="col-sm-8">
  ...
  <div class="modal" id="viewSpkModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="spkModalLabel">Cari Input Gudang</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddDet1" aria-labelledby="offcanvasAddLabelDet1">
    ...
    <div class="offcanvas-body mx-0 flex-grow-0 h-100">
      <form class="add-new-user pt-0" id="addNewDataFormDet1">
        ...
        <input type="hidden" name="unit_akhir" id="unit_akhir">
        <input type="hidden" name="kode_cabang" id="kode_cabang" value="{{ $user_cabang }}">
        
        <div class="form-floating form-floating-outline mb-5 form-control-validation">
          <select id="add-bahan" name="kode_bahan" class="select2-ajax form-select input-wajib">
        ...
        <div class="form-floating form-floating-outline mb-5 form-control-validation">
          <select id="add-satuan" name="kode_satuan" class="select2 form-select input-wajib">
        ...
        <div class="form-floating form-floating-outline mb-5 form-control-validation">
          <input type="text" class="form-control invoice-price input-wajib" id="add-qty-bahan" name="qty" placeholder="Qty" />
          <label for="add-qty-bahan">Qty</label>
        </div>
        <div class="form-floating form-floating-outline mb-5 form-control-validation">
          <input type="text" class="form-control invoice-price input-wajib" id="add-harga-bahan" name="harga" placeholder="Harga" readonly />
