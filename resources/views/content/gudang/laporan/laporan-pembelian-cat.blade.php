...
@section('page-script')
  <script src="{{ asset('assets/js/laporan-pembelian-cat.js') }}"></script>
@endsection
...
<div class="row">
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form id="filterForm" class="form-control-validation" method="post" action="{{ url('laporan-pembelian-cat-list') }}" autocomplete="off">
          @csrf
          <div class="row mb-4">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div class="card-title mb-0">
          <h5 class="m-0 me-2">Laporan Pembelian Cat</h5>
        </div>
      ...
      <div class="card-datatable">
        <table class="datatables-pembelian-cat table table-bordered table-responsive" data-title="{{ $title }}"
