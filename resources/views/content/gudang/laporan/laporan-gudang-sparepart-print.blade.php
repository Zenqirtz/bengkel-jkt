    ...
    <div class="invoice-print p-12">
        <div class="d-flex justify-content-between flex-row">
            <div class="mb-6">
                ...
                <p class="mb-1">Laporan Input Gudang Sparepart</p>
...
@section('content')
    <div class="invoice-print">
        ...
        <div class="header-sub">Laporan Input Gudang Sparepart</div>
            ...
            <tbody>
                @foreach ($datas as $index => $row)
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="white-space:nowrap;">{{ date('d/m/Y', strtotime($row->tanggal)) }}
                        </td>
                ...
                @if (count($datas) > 0)
                    ...
                    <tr class="row-grand-total">
                        <td class="text-right" style="font-weight:bold;" colspan="7">Grand Total</td>
