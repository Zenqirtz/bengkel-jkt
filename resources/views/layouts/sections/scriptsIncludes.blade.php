...
@if (config('variables.gTag'))  
  <!-- Google Analytics script -->
  <script async src="https://www.googletagmanager.com/gtag/js?id={{ config('variables.gTagValue') }}"></script>
  <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', @json(config('variables.gTagValue')));
  </script>
@endif
